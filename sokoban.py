...
policy,graph = run_montecarlo(env, log=True, initial_config=config)
policy,graph = run_sarsa(env, log=True, initial_config=config)
policy,graph = run_qlearning(env, log=True, initial_config=config)
